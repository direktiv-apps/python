...
//go:generate swagger generate server --target ../../app --name Python --spec ../../../swagger.yaml --template-dir /home/jensg/go/src/github.com/direktiv-apps/python/build/templates --principal interface{}

func configureFlags(api *operations.PythonAPI) {
...
func configureAPI(api *operations.PythonAPI) http.Handler {
